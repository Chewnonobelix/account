...
class Transaction : public QObject,
  ...
  Q_PROPERTY(QString description READ description WRITE setDescription NOTIFY
                 descriptionChanged)
  Q_PROPERTY(OpenAccountEnums::Support support READ support WRITE setSupport
                 NOTIFY supportChanged)
  Q_PROPERTY(QDate date READ date WRITE setDate NOTIFY dateChanged)
  Q_PROPERTY(OpenAccountEnums::Movement movement READ movement WRITE setMovement
                 NOTIFY movementChanged)
  Q_PROPERTY(
      bool isVisible READ isVisible WRITE setIsVisible NOTIFY isVisibleChanged)
  Q_PROPERTY(
      QUuid accountId READ accountId WRITE setAccountId NOTIFY accountIdChanged)
  Q_PROPERTY(
      QUuid category READ category WRITE setCategory NOTIFY categoryChanged)
