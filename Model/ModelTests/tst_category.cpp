...
void CategoryTest::testDefaultConstruction()
{
    ...
    // Direction should be a valid Movement value; we assume default constructed value is valid
    OpenAccountEnums::Movement direction = category.direction();
    QVERIFY(direction == OpenAccountEnums::Movement::Credit || direction == OpenAccountEnums::Movement::Debit || direction == OpenAccountEnums::Movement::Both);
}
